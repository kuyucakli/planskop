      ...
      <section className="text-md ">
        ...
        <div className="max-w-2xl ">
          ...
          <p className="my-4">
            ...
            routines that last, not just checking boxes. Over time, I plan to
            add habit creation sources, inspirational examples, and gentle
            guidance to make starting easier. Right now, Planskop helps by
            sending gentle reminders of your daily goals. And you can attach
            images to your actions — as motivation, reminders, or just personal
            meaning. We know that actions repeated day after day slowly shape
            who we are, forming patterns that become visible in our lives.
            Planskop is here to help you notice those patterns — and design the
            ones you want to live by.
          </p>
