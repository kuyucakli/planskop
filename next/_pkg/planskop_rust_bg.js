...
export function get_closest_action_dates(action_plans_json) {
    ...
    try {
        ...
        wasm.get_closest_action_dates(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
...
export function calc_with_remind_kind(dt, remind_kind, operation) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.calc_with_remind_kind(retptr, ptr0, len0, remind_kind, operation);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
...
export function with_timezone_offset(dt, offset) {
    ...
    try {
        ...
        wasm.with_timezone_offset(retptr, ptr0, len0, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred3_0 = r0;
        deferred3_1 = r1;
...
export function get_next_remind_dt(_rruleset, remind_kind, current_remind_dt) {
    ...
    try {
        ...
        wasm.get_next_remind_dt(retptr, ptr0, len0, remind_kind, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred3_0 = r0;
        deferred3_1 = r1;
...
export function get_local_timezone() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.get_local_timezone(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
export function get_dt_str_from_rruleset(_rruleset) {
    ...
    try {
        ...
        const ptr0 = passStringToWasm0(_rruleset, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.get_dt_str_from_rruleset(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
...
export function format_ical(dtstart, until, frequency, interval, count, by_week_day) {
    ...
    try {
        ...
        wasm.format_ical(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred7_0 = r0;
        deferred7_1 = r1;
...
export function subtract_gmt_offset(dt, gmt_offset_str) {
    ...
    try {
        ...
        const len1 = WASM_VECTOR_LEN;
        wasm.subtract_gmt_offset(retptr, ptr0, len0, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred3_0 = r0;
        deferred3_1 = r1;
...
export function get_human_readable_rrule(_rruleset) {
    ...
    try {
        ...
        const ptr0 = passStringToWasm0(_rruleset, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.get_human_readable_rrule(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
...
/**
*/
export const RemindKind = Object.freeze({ OneHourBefore:0,"0":"OneHourBefore",TwoHoursBefore:1,"1":"TwoHoursBefore",OneDayBefore:2,"2":"OneDayBefore",TwoDaysBefore:3,"3":"TwoDaysBefore", });
/**
*/
export const Operation = Object.freeze({ Add:0,"0":"Add",Subtract:1,"1":"Subtract", });
...
export function __wbg_newwithyearmonthdayhrminsec_d95c77209c89164d(arg0, arg1, arg2, arg3, arg4, arg5) {
