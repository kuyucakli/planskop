...
export function NavMain() {
    ...
    return (
        <nav className={`${styles.Nav} ${styles.NavMain}`}>
            ...
            <ul>
                <li>
                    <Link rel="stylesheet" href="/dashboard" className={pathName == "/dashboard" ? "active" : ""}>
                ...
                <li>
                    <Link rel="stylesheet" href="/planner" className={pathName == "/planner" ? "active" : ""}>
                ...
                <li>
                    <Link rel="stylesheet" href="/habits" className={pathName == "/habits" ? "active" : ""}><svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <Link rel="stylesheet" href="/insights" className={pathName == "/insights" ? "active" : ""}>
                        <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
